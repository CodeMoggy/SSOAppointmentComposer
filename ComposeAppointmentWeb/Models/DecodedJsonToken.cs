...
namespace ComposeAppointmentWeb.Models
{
    public class DecodedJsonToken : IDisposable
    {
        ...
        private void ValidateAudience()
        {
            ...
            // get the website url the add-in is hosted
            var addinHost = WebConfigurationManager.AppSettings["ADDIN_HOST"];

            string location = addinHost.Replace("/", "-").Replace("\\", "-");
            ...
            if (!location.Equals(audience))
            {
                throw new ApplicationException(String.Format(
                  ...
                  addinHost, this.payloadClaims[AuthClaimTypes.Audience]));
            }
        }
